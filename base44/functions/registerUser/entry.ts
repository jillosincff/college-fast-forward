...
async function triggerVerificationEmail(email, token, origin) {
  ...
  const emailBody = `
    <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: auto; background: #f8f9ff; padding: 40px 20px;">
      ...
      <div style="background: #fff; border-radius: 20px; overflow: hidden; box-shadow: 0 4px 16px rgba(109,40,217,0.12);">
        <div style="background: linear-gradient(135deg, #6d28d9 0%, #7c3aed 100%); padding: 36px 36px 32px;">
          ...
          <p style="font-size: 15px; color: rgba(255,255,255,0.8); margin: 0; line-height: 1.6;">Confirm your email to activate your account and start finding warm paths into the companies you care about.</p>
        </div>
        <div style="padding: 28px 36px 32px;">
          <p style="font-size: 15px; color: #475569; line-height: 1.7; margin: 0 0 16px;">Thanks for joining College Fast Forward. Click the button below to verify your email address and finish setting up your account.</p>
          <div style="text-align: center; margin: 8px 0 20px;">
            <a href="${verificationUrl}" style="display: inline-block; background: linear-gradient(135deg, #6d28d9 0%, #7c3aed 100%); color: #fff; font-size: 14px; font-weight: 700; text-decoration: none; padding: 14px 32px; border-radius: 14px;">Verify My Email →</a>
          </div>
