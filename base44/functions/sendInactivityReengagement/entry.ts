...
const ctaButton = (label) => `
  <div style="text-align: center; margin: 8px 0 4px;">
    <a href="${APP_URL}" style="display: inline-block; background: #6d28d9; color: #fff; font-size: 14px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 10px;">${label} →</a>
  </div>`;
