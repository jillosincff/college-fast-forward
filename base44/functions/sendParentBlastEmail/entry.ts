      ...
      <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td style="width:28px;vertical-align:top;padding-top:1px;">
                        <table cellpadding="0" cellspacing="0" border="0"><tr><td style="width:20px;height:20px;background-color:#E85D20;border-radius:10px;text-align:center;"><span style="font-size:11px;color:#ffffff;font-family:Georgia,serif;font-weight:700;line-height:20px;display:inline-block;">1</span></td></tr></table>
                      </td>
                      <td style="padding-left:10px;"><p style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:15px;color:#1a1a1a;line-height:1.6;margin:0;"><strong>Alumni Search</strong> — finds UF alumni working at their target companies, with AI-drafted outreach that actually sounds human</p></td>
                    </tr>
                  </table>
                </td>
              </tr>
              <tr>
                <td style="padding:10px 0;border-bottom:1px solid #f0f0f0;">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td style="width:28px;vertical-align:top;padding-top:1px;">
                        <table cellpadding="0" cellspacing="0" border="0"><tr><td style="width:20px;height:20px;background-color:#E85D20;border-radius:10px;text-align:center;"><span style="font-size:11px;color:#ffffff;font-family:Georgia,serif;font-weight:700;line-height:20px;display:inline-block;">2</span></td></tr></table>
                      </td>
                      <td style="padding-left:10px;"><p style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:15px;color:#1a1a1a;line-height:1.6;margin:0;"><strong>Company Intel</strong> — real-time hiring signals from the companies they care about most</p></td>
                    </tr>
                  </table>
                </td>
              </tr>
              <tr>
                <td style="padding:10px 0;border-bottom:1px solid #f0f0f0;">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td style="width:28px;vertical-align:top;padding-top:1px;">
                        <table cellpadding="0" cellspacing="0" border="0"><tr><td style="width:20px;height:20px;background-color:#E85D20;border-radius:10px;text-align:center;"><span style="font-size:11px;color:#ffffff;font-family:Georgia,serif;font-weight:700;line-height:20px;display:inline-block;">3</span></td></tr></table>
                      </td>
                      <td style="padding-left:10px;"><p style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:15px;color:#1a1a1a;line-height:1.6;margin:0;"><strong>Resume Tailoring</strong> — scores and rewrites their resume for specific roles and companies</p></td>
                    </tr>
                  </table>
                </td>
              </tr>
              <tr>
                <td style="padding:10px 0;border-bottom:1px solid #f0f0f0;">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td style="width:28px;vertical-align:top;padding-top:1px;">
                        <table cellpadding="0" cellspacing="0" border="0"><tr><td style="width:20px;height:20px;background-color:#E85D20;border-radius:10px;text-align:center;"><span style="font-size:11px;color:#ffffff;font-family:Georgia,serif;font-weight:700;line-height:20px;display:inline-block;">4</span></td></tr></table>
                      </td>
                      <td style="padding-left:10px;"><p style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:15px;color:#1a1a1a;line-height:1.6;margin:0;"><strong>Mock Interviews</strong> — AI-powered practice with real, specific feedback</p></td>
                    </tr>
                  </table>
                </td>
              </tr>
              <tr>
                <td style="padding:10px 0;">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td style="width:28px;vertical-align:top;padding-top:1px;">
                        <table cellpadding="0" cellspacing="0" border="0"><tr><td style="width:20px;height:20px;background-color:#E85D20;border-radius:10px;text-align:center;"><span style="font-size:11px;color:#ffffff;font-family:Georgia,serif;font-weight:700;line-height:20px;display:inline-block;">5</span></td></tr></table>
                      </td>
                      <td style="padding-left:10px;"><p style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:15px;color:#1a1a1a;line-height:1.6;margin:0;"><strong>Personalized Daily Briefing</strong> — tells them exactly what to do next based on where they are in their search</p></td>
                    </tr>
                  </table>
                </td>
              </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#1a0e06;border-radius:16px;margin-bottom:32px;border:2px solid #8B2E0A;">
              <tr>
                <td style="padding:32px 28px;">
                  ...
                  <p style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;color:#ffffff;line-height:1.7;margin:0 0 16px;">
                    For the next 7 days, you can unlock the full FastIQ experience for your student — completely free, no credit card needed.
                  </p>
                  <p style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;color:#cccccc;line-height:1.7;margin:0 0 28px;">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td style="background-color:#E85D20;border-radius:12px;">
                        <a href="https://collegefastforward.com/#GiftFastIQ" style="display:inline-block;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;font-weight:700;color:#ffffff;text-decoration:none;padding:16px 32px;border-radius:12px;letter-spacing:0.01em;">
                          Give My Student FastIQ Free &rarr;
                        </a>
                      </td>
                    </tr>
                  </table>
        ...
        <tr>
          <td align="center" style="padding-bottom:32px;">
            ...
            <p style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:12px;color:#aaaaaa;line-height:1.6;margin:0;">You're receiving this because you're a member of the UF parent network.</p>
          </td>
        </tr>
