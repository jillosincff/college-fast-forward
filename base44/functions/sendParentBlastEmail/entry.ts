...
Deno.serve(async (req) => {
  ...
  for (const parent of parents) {
    ...
    try {
      await sendViaSendGrid(parent.email, firstName, SENDGRID_API_KEY, body.subject, body.html_body);
      results.sent++;
