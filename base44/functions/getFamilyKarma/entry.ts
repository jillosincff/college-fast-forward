...
// Karma tiers — STANDARD across all files
const KARMA_TIERS = [
  { name: 'none', threshold: 0, boost: 0, benefit: '' },
  { name: 'active', threshold: 100, boost: 1, benefit: 'Active Family badge on profile' },
  { name: 'engaged', threshold: 300, boost: 2, benefit: 'Boosted in match results' },
  { name: 'priority', threshold: 500, boost: 3, benefit: 'Priority placement in matches' },
  { name: 'champion', threshold: 1000, boost: 5, benefit: 'Featured in directory' }
];
