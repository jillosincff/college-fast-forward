...
const JOB_POOL = {
  ...
  'human resources': [
    { company: 'Lattice', role: 'People Operations Coordinator', description: 'Lattice is the leading performance management platform used by over 10,000 companies worldwide. As a People Operations Coordinator, you will support a team of 8 HR professionals managing recruiting, onboarding, benefits administration, and employee experience programs. This role is perfect for someone passionate about creating exceptional employee experiences at a high-growth HR tech company. You will gain exposure to HRIS systems (Greenhouse, Rippling, Lattice), coordinate new hire orientations, manage HR documentation, and support culture initiatives. The team operates in a fully remote environment with quarterly offsites. Key responsibilities: manage offer letter generation and background check coordination, own new hire onboarding scheduling and logistics, maintain HRIS data integrity and generate headcount reports, coordinate quarterly engagement surveys and action planning, support benefits administration during open enrollment periods. Requirements: 0-2 years experience in HR or operations role, exceptional organizational and communication skills, proficiency with Google Suite and comfort learning new software systems, demonstrated interest in people operations or talent management. Lattice offers competitive salary ($65-80K), equity package, 100% medical/dental/vision coverage, unlimited PTO, $3K annual learning stipend, and home office setup budget.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Rippling', role: 'HR Generalist (New Grad)', description: 'Rippling is building the first unified workforce platform, combining HR, IT, and Finance in one system. As an HR Generalist, you will be a true generalist supporting all aspects of people operations: full-cycle recruiting coordination, onboarding 50+ new hires monthly, administering benefits across 3 states, managing employee relations, and ensuring compliance with employment laws. This role reports directly to the VP of People and offers unparalleled exposure to scaling a hypergrowth company. Ideal for someone who thrives in ambiguity and wants to build HR programs from the ground up. Responsibilities span the entire employee lifecycle: partner with hiring managers to coordinate interview processes and candidate communications, design and deliver new hire orientation programs for 50+ monthly hires, administer health benefits, 401(k), and equity enrollment across California, New York, and Texas, serve as first point of contact for employee relations questions and policy guidance, maintain compliance with federal, state, and local employment regulations, track and report on key people metrics including headcount, turnover, and time-to-hire. Requirements: Bachelors degree or equivalent practical experience, strong interest in building scalable HR operations, excellent written and verbal communication skills, ability to manage multiple priorities in fast-paced environment, discretion handling confidential information. Rippling offers $70-85K base salary, meaningful equity, full health benefits, and the opportunity to build HR infrastructure at a company valued at $13B.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Gusto', role: 'People Operations Associate', description: 'Gusto is a modern payroll, benefits, and HR platform serving 300,000+ businesses. The People Operations Associate role supports Gusto internal HR team of 15, focusing on employee lifecycle operations. This is a high-impact role at a company that practices what it preaches. Responsibilities include: coordinating interview loops and candidate communications for 100+ annual hires, managing I-9 verification and background check processes for compliance, administering open enrollment for 1,200+ employees including benefits education sessions, tracking HR metrics and generating compliance reports for leadership, supporting DEI initiatives including ERG programming and inclusive hiring practices, maintaining employee records and HRIS data integrity. Requirements: 0-2 years experience in HR, operations, or customer-facing role, passion for creating exceptional employee experiences, strong attention to detail and process improvement mindset, comfort with data and ability to generate insights from HR metrics. Gusto offers $68-82K salary, equity grant, 100% employer-paid health/dental/vision premiums, unlimited PTO with 15-day minimum, $3,000 annual professional development stipend, parental leave, and remote-first culture with annual company retreats.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'HR Tech Startup', role: 'Talent Coordinator', description: 'Posted inside the Lattice "Resources for Humans" Slack community — this Seed-stage HR tech startup (40 employees, $8M raised) is hiring their first dedicated Talent Coordinator. You will own the entire recruiting coordination process: scheduling 30+ interviews weekly, managing candidate pipelines in Greenhouse, coordinating offer letters and negotiations, and building onboarding playbooks. This is a rare opportunity to be employee #45 at a company solving real problems in performance management. Direct reporting to the founder/CEO with significant equity upside. The company just closed Series A and is scaling from 40 to 100 employees in 2026. You'll be the operational backbone of this growth, building processes that will scale with the company. Day-to-day responsibilities: own interview scheduling logistics for 5-7 open roles simultaneously, manage candidate experience from application through offer including reference checks, coordinate offer letter generation using DocuSign and negotiate start dates, design and deliver new hire onboarding including first-week scheduling and buddy assignments, maintain recruiting metrics dashboard and weekly pipeline reports for leadership, source passive candidates via LinkedIn Recruiter for hard-to-fill roles. Requirements: 1-3 years experience in recruiting coordination, talent acquisition, or operations role, experience with Greenhouse or similar ATS required, exceptional organizational skills and ability to manage 30+ moving pieces weekly, strong written communication skills for candidate correspondence, genuine interest in startup environment and wearing multiple hats. Compensation: $60-75K base salary, 0.1-0.25% equity (early employee package), health/dental/vision stipend, flexible PTO, remote-friendly with monthly team offsites in SF.', source: 'lattice.com/resources-for-humans', sourceCategory: 'E', nichePlatform: 'lattice_rfh' },
    { company: 'Mid-Market SaaS Co.', role: 'HR Coordinator', description: 'This established B2B SaaS company (200 employees, $30M ARR) is quietly hiring an HR Coordinator through the SHRM job board — a channel most new graduates overlook. You will support a team of 4 HR generalists managing day-to-day people operations for a stable, profitable company with strong work-life balance. Responsibilities: benefits administration for 200+ employees across 5 states including new hire enrollment, qualifying life events, and COBRA management, coordinating performance review cycles twice annually including manager training and system administration, managing HRIS data integrity in BambooHR including org chart updates and reporting, tracking compliance training completion and maintaining employee files for audit readiness, supporting employee engagement programs including recognition platforms and team events, answering employee questions about policies, benefits, and HR processes via email and Slack. Requirements: Bachelor's degree in HR, Business, or related field (or equivalent experience), 0-2 years experience in HR or administrative role, strong attention to detail and comfort working with sensitive data, excellent customer service orientation and communication skills, interest in growing HR career with company that promotes from within. The company offers 38-hour work weeks (rare in tech), hybrid remote arrangement (3 days in office), $55-65K salary, 4% 401(k) match, 80% employer-paid health premiums, 15 days PTO plus holidays, clear promotion path to HR Generalist within 18 months, and tuition reimbursement for HR certification programs. This is an ideal role for someone wanting stable HR experience with work-life balance.', source: 'shrm.org/jobs', sourceCategory: 'E', nichePlatform: 'shrm' },
  ],
  'tech': [
  ...
  'media and entertainment': [
    ...
    { company: 'Disney', role: 'Content Coordinator', description: 'Disney Streaming is hiring a Content Coordinator to manage editorial calendars and content rollout across Disney+, Hulu, and ESPN+. Creative writing and organizational skills required.', source: 'disney.com/careers', sourceCategory: 'C' },
    { company: 'Spotify', role: 'UX Writer', description: 'Spotify is looking for a UX writer to craft the voice and language of the world\'s largest audio platform. Role involves working with product designers on app copy, onboarding flows, and notifications.', source: 'dribbble.com/jobs', sourceCategory: 'E', nichePlatform: 'dribbble' },
    { company: 'Buzzfeed', role: 'Junior Content Strategist', description: 'BuzzFeed is hiring a junior content strategist for their branded content studio — working directly with editorial and brand teams on social-first campaigns.', source: 'workingnotworking.com', sourceCategory: 'E', nichePlatform: 'workingnotworking' },
    { company: 'Hulu', role: 'Brand Designer', description: 'Hulu is sourcing a brand designer for their in-house creative team — posted on Dribbble to target designers actively creating, not just job hunting.', source: 'dribbble.com/jobs', sourceCategory: 'E', nichePlatform: 'dribbble' },
    { company: 'Warner Bros Discovery', role: 'Social Media Coordinator', description: 'Entry-level social media coordinator role across WBD\'s flagship properties including HBO Max, CNN, and DC Entertainment.', source: 'wbd.com/careers', sourceCategory: 'C' },
  ],
  'media & entertainment': [
    { company: 'Netflix', role: 'Junior Content Designer', description: 'Netflix is hiring junior content designers for their product design team — creative roles with real ownership over how 250M subscribers experience the interface.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
