...
const JOB_POOL = {
  ...
  'finance & insurance': [
    ...
    { company: 'Bank of America', role: 'Credit Analyst', companyTier: 1, description: 'Underwrite commercial loans and prepare credit memos across US offices.', source: 'bankofamerica.com/careers', sourceCategory: 'C' },
    { company: 'Vanguard', role: 'Investment Analyst', companyTier: 1, description: 'Portfolio analytics, fund analysis, and research support in Malvern, PA.', source: 'vanguardjobs.com', sourceCategory: 'C' },
    { company: 'Charles Schwab', role: 'Financial Advisor Associate', companyTier: 1, description: 'Client portfolio management and financial planning support across US offices.', source: 'schwab.com/careers', sourceCategory: 'C' },
    { company: 'Wells Fargo', role: 'Corporate Finance Analyst', companyTier: 1, description: 'Entry-level analyst program supporting corporate banking and finance teams.', source: 'wellsfargojobs.com', sourceCategory: 'C' },
    { company: 'American Express', role: 'Financial Analyst', companyTier: 1, description: 'FP&A and risk analytics roles across the consumer and commercial finance divisions.', source: 'jobs.americanexpress.com', sourceCategory: 'C' },
    ...
    { company: 'Affirm', role: 'Credit Risk Analyst', companyTier: 2, description: 'Underwriting model development and portfolio monitoring at BNPL leader.', source: 'affirm.com/careers', sourceCategory: 'B' },
    { company: 'Marqeta', role: 'Finance Operations Analyst', companyTier: 2, description: 'Card issuing platform scaling globally — finance analyst roles with real ownership.', source: 'marqeta.com/careers', sourceCategory: 'B' },
    { company: 'Nerdwallet', role: 'Business Analyst', companyTier: 2, description: 'Personal finance platform hiring for analytics and business operations roles.', source: 'nerdwallet.com/careers', sourceCategory: 'B' },
    ...
    { company: 'Clearco', role: 'Investment Analyst', companyTier: 3, description: 'Revenue-based financing startup for e-commerce brands — analyst roles with direct exposure to deal flow.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Pipe', role: 'Capital Markets Analyst', companyTier: 3, description: 'Series C fintech enabling recurring revenue financing — team of 100, high ownership from day one.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Sentieo', role: 'Financial Research Analyst', companyTier: 3, description: 'AI-powered investment research platform — analyst roles supporting fintech and institutional clients.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Hometap', role: 'Investment Operations Analyst', companyTier: 3, description: 'Series C home equity investment platform — team of 200, operations and investment analyst roles.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Vestwell', role: 'Finance Operations Associate', companyTier: 3, description: 'Series C digital retirement plan provider — finance and ops roles with direct client impact.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
  ],
  'human resources': [
    // Tier 1
  ...
  'tech': [
    ...
    { company: 'Salesforce', role: 'Associate Software Engineer', companyTier: 1, description: 'Rotational and entry-level engineering roles across the Salesforce platform.', source: 'salesforce.com/careers', sourceCategory: 'C' },
    ...
    { company: 'Apple', role: 'Software Engineer (New Grad)', companyTier: 1, description: 'Engineering roles across iOS, macOS, and services teams. Strong new grad program.', source: 'jobs.apple.com', sourceCategory: 'C' },
    { company: 'Amazon', role: 'Software Development Engineer', companyTier: 1, description: 'SDE new grad program across AWS, retail, and Alexa teams.', source: 'amazon.jobs', sourceCategory: 'C' },
    { company: 'IBM', role: 'Associate Software Engineer', companyTier: 1, description: 'Entry-level engineering and consulting roles across cloud and AI divisions.', source: 'ibm.com/careers', sourceCategory: 'C' },
    // Tier 2
    ...
    { company: 'Webflow', role: 'Junior Front-End Engineer', companyTier: 2, description: 'No-code platform with strong engineering culture. Build UI components and ship features for 300K+ customers. $130,000-155,000 + equity.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Figma', role: 'Product Engineer', companyTier: 2, description: 'Design infrastructure team. Core product engineering and performance optimization. $160,000-190,000 + equity.', source: 'dribbble.com/jobs', sourceCategory: 'E', nichePlatform: 'dribbble' },
    { company: 'Airtable', role: 'Software Engineer', companyTier: 2, description: 'No-code database platform scaling enterprise — engineering roles with direct product ownership.', source: 'airtable.com/careers', sourceCategory: 'B' },
    { company: 'Twilio', role: 'Software Engineer (New Grad)', companyTier: 2, description: 'Cloud communications platform — engineering roles across messaging, voice, and video APIs.', source: 'twilio.com/en-us/company/jobs', sourceCategory: 'B' },
    { company: 'Datadog', role: 'Software Engineer', companyTier: 2, description: 'Cloud monitoring and analytics platform — engineering roles across backend, frontend, and infrastructure.', source: 'careers.datadoghq.com', sourceCategory: 'B' },
    { company: 'HashiCorp', role: 'Software Engineer', companyTier: 2, description: 'Infrastructure automation platform — open source engineering culture, remote-first roles.', source: 'hashicorp.com/jobs', sourceCategory: 'B' },
    { company: 'Cloudflare', role: 'Software Engineer', companyTier: 2, description: 'Internet infrastructure company — engineering roles across networking, security, and developer tools.', source: 'cloudflare.com/careers', sourceCategory: 'B' },
    // Tier 3
    { company: 'Linear', role: 'Product Designer', companyTier: 3, description: 'Remote-first | Team of 50. Premium issue-tracking tool. Design core product workflows and contribute to design system. Top-of-market + equity.', source: 'keyvalues.com', sourceCategory: 'E', nichePlatform: 'keyvalues' },
    { company: 'Ramp', role: 'Software Engineer', companyTier: 3, description: 'New York, NY | Series D fintech. Real engineering ownership from day one.', source: 'ramp.com/careers', sourceCategory: 'B' },
    { company: 'Retool', role: 'Software Engineer', companyTier: 3, description: 'San Francisco/Remote | Series C internal tools platform. Build core platform features used by 100K+ developers. $160,000-200,000 + equity.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Vercel', role: 'Growth Engineer', companyTier: 3, description: 'Remote-first | Series C developer platform. Build onboarding flows and instrument analytics. $130,000-160,000 + equity.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Supabase', role: 'Software Engineer', companyTier: 3, description: 'Remote-first open source Firebase alternative — Series B, team of 80, strong engineering culture.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'PlanetScale', role: 'Developer Advocate Engineer', companyTier: 3, description: 'Remote-first | Series C serverless database platform. Engineering and devrel roles with direct product access.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Fly.io', role: 'Software Engineer', companyTier: 3, description: 'Remote-first | Developer infrastructure startup — team of 40, high-ownership engineering roles.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Descript', role: 'Software Engineer', companyTier: 3, description: 'Remote-friendly | Series C audio/video editing platform. Team of 150. Engineering roles across web, mobile, and desktop.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Loom', role: 'Product Engineer', companyTier: 3, description: 'Remote-first | Async video platform used by 25M+ people. Full-stack product engineering roles.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Cal.com', role: 'Software Engineer', companyTier: 3, description: 'Remote-first open source scheduling platform — early-stage, direct founder access, high impact from day one.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Resend', role: 'Software Engineer', companyTier: 3, description: 'Remote-first | YC-backed email API startup. Team of 20. Engineering roles with massive ownership and direct user feedback loop.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Turso', role: 'Developer Advocate', companyTier: 3, description: 'Remote-first | Edge database startup backed by top VCs. Small team, massive growth, direct engineering collaboration.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Prisma', role: 'Software Engineer', companyTier: 3, description: 'Remote-first | Open source ORM and database tooling company. Team of 60, Series B.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
  ],
  'technology': [
    { company: 'Google', role: 'Software Engineer (New Grad)', companyTier: 1, description: 'Engineering and product roles across cloud, AI, and consumer teams.', source: 'careers.google.com', sourceCategory: 'C' },
    { company: 'Microsoft', role: 'Software Development Engineer', companyTier: 1, description: 'New grad programs spanning cloud, AI, and productivity divisions.', source: 'careers.microsoft.com', sourceCategory: 'C' },
    { company: 'Salesforce', role: 'Associate Software Engineer', companyTier: 1, description: 'Rotational and entry-level engineering roles.', source: 'salesforce.com/careers', sourceCategory: 'C' },
    { company: 'Meta', role: 'Data Engineer', companyTier: 1, description: 'Data and engineering roles across ads and product infrastructure.', source: 'metacareers.com', sourceCategory: 'B' },
    ...
    { company: 'Amazon', role: 'Software Development Engineer', companyTier: 1, description: 'SDE new grad program across AWS, retail, and Alexa.', source: 'amazon.jobs', sourceCategory: 'C' },
    { company: 'Airtable', role: 'Software Engineer', companyTier: 2, description: 'No-code database platform — engineering roles with direct product ownership.', source: 'airtable.com/careers', sourceCategory: 'B' },
    ...
    { company: 'Twilio', role: 'Software Engineer (New Grad)', companyTier: 2, description: 'Cloud communications platform — messaging, voice, and video API engineering roles.', source: 'twilio.com/en-us/company/jobs', sourceCategory: 'B' },
    { company: 'Webflow', role: 'Junior Front-End Engineer', companyTier: 2, description: 'No-code platform. Build UI components and ship features for 300K+ customers. $130,000-155,000 + equity.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Retool', role: 'Software Engineer', companyTier: 3, description: 'Series C internal tools platform used by 100K+ developers. $160,000-200,000 + equity.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Vercel', role: 'Growth Engineer', companyTier: 3, description: 'Remote-first Series C developer platform. $130,000-160,000 + equity.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Supabase', role: 'Software Engineer', companyTier: 3, description: 'Open source Firebase alternative — Series B, remote-first, strong engineering culture.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Ramp', role: 'Software Engineer', companyTier: 3, description: 'Series D fintech. Real engineering ownership from day one.', source: 'ramp.com/careers', sourceCategory: 'B' },
    { company: 'Descript', role: 'Software Engineer', companyTier: 3, description: 'Series C audio/video editing platform. Team of 150, web/mobile/desktop engineering.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Loom', role: 'Product Engineer', companyTier: 3, description: 'Async video platform used by 25M+ people. Full-stack product engineering roles.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Resend', role: 'Software Engineer', companyTier: 3, description: 'YC-backed email API startup, team of 20. Massive ownership and direct user feedback loop.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Prisma', role: 'Software Engineer', companyTier: 3, description: 'Open source ORM company, Series B, team of 60. Remote-first with strong dev community.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Linear', role: 'Product Designer', companyTier: 3, description: 'Remote-first, team of 50. Design product workflows and contribute to design system.', source: 'keyvalues.com', sourceCategory: 'E', nichePlatform: 'keyvalues' },
  ],
  ...
  'media and entertainment': [
    ...
    { company: 'Morning Brew', role: 'Content Strategist', companyTier: 3, description: 'Location: Remote-friendly | Independent media brand with 4M+ subscribers. Responsibilities: Editorial planning, content strategy, audience growth. Compensation: $60,000-75,000 base + equity.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Substack', role: 'Product Designer', companyTier: 3, description: 'Location: Remote-first | Newsletter publishing platform, team of 80. Responsibilities: Product design, content tools UX, design system contributions.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Workweek Media', role: 'Content Associate', companyTier: 3, description: 'Location: Remote-first | Creator-first B2B media startup. Team of 30. Responsibilities: Editorial writing, newsletter production, audience development.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
  ],
  'media & entertainment': [
    ...
    { company: 'Morning Brew', role: 'Content Strategist', companyTier: 3, description: 'Independent media brand with 4M+ subscribers — editorial and content strategy roles with direct creative ownership.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Substack', role: 'Product Designer', companyTier: 3, description: 'Newsletter publishing platform — design and content roles. Team of 80, high ownership from day one.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
    { company: 'Workweek Media', role: 'Content Associate', companyTier: 3, description: 'Creator-first B2B media startup — editorial and content strategy roles, small tight-knit team.', source: 'wellfound.com/jobs', sourceCategory: 'E', nichePlatform: 'wellfound' },
  ],
  'content & ux design': [
    { company: 'Figma', role: 'Brand Designer', companyTier: 2, description: 'Design tool powerhouse — role posted on Dribbble Jobs to reach designers actively sharing their work.', source: 'dribbble.com/jobs', sourceCategory: 'E', nichePlatform: 'dribbble' },
    { company: 'Mailchimp', role: 'UX Writer', companyTier: 2, description: 'Strong brand and content culture — curated on Key Values for candidates who care about autonomy and craft.', source: 'keyvalues.com', sourceCategory: 'E', nichePlatform: 'keyvalues' },
