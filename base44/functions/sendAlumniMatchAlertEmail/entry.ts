...
function html({ firstName, alumni, targetRole, targetCompany }) {
    ...
    <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;max-width:560px;width:100%">
      ...
      <tr><td style="padding:28px 40px">
        ...
        <div style="text-align:center;margin-bottom:8px">
          <a href="${APP_URL}/#FreeTierDashboard?tab=alumni_search" style="display:inline-block;background:#E85D20;color:#ffffff;text-decoration:none;font-size:14px;font-weight:600;padding:13px 32px;border-radius:100px">View All Matches →</a>
        </div>
      </td></tr>
