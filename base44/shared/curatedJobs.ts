...
const REMOTE_BY_ROLE: Record<string, CuratedJob[]> = {
  ...
  healthcare: [
    ...
    mk('CVS Health', 'Pharmacy Technician (Remote)', 'Healthcare', 'Remote',
      'CVS Health Pharmacy Technicians support prescription processing and patient outreach — remote-eligible entry role.',
      'https://jobs.cvshealth.com/'),
    mk('Humana', 'Care Coordinator (Remote)', 'Healthcare', 'Remote',
      'Humana Care Coordinators guide members through care plans and provider coordination — remote-eligible.',
      'https://careers.humana.com/'),
    mk('Teladoc Health', 'Clinical Operations Coordinator (Remote)', 'Healthcare', 'Remote',
      'Teladoc Health Clinical Operations Coordinators support virtual care delivery workflows — remote-eligible.',
      'https://www.teladochealth.com/careers/'),
    mk('Cigna', 'Patient Care Coordinator (Remote)', 'Healthcare', 'Remote',
      'Cigna Patient Care Coordinators support member care plans and provider scheduling — remote-eligible.',
      'https://jobs.cigna.com/'),
    mk('Included Health', 'Care Coordinator (Remote)', 'Healthcare', 'Remote',
      'Included Health Care Coordinators help members navigate the healthcare system end-to-end — fully remote.',
