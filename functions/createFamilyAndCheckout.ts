...
const STANDARD_PRICE = 2900;
const STRIPE_PRICE_EARLY_ADOPTER = 'price_1SUJ2g873TV7WMcTBYvmzGYU'; // $9/month CFF tier
const STRIPE_PRICE_STANDARD = 'price_1SUJ7I873TV7WMcT1plkAZpz'; // $29/month FASTIQ tier
const TRIAL_DAYS = 7;
