...
<body style="margin:0;padding:0;background-color:#f4f2ee;font-family:${DM};-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">
<div style="display:none;font-size:1px;color:#f4f2ee;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;mso-hide:all;">${preheader}&#847;&zwnj;&nbsp;&#847;&zwnj;&nbsp;&#847;&zwnj;&nbsp;</div>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr>
<td style="font-family:${DM};font-size:11px;font-weight:300;color:#5a574f;line-height:1.6;">&copy; ${YR} College Fast Forward.<br><a href="${APP}/#ProfileEdit" style="color:#8a867e;text-decoration:underline;">Unsubscribe</a> &middot; <a href="${APP}/#ProfileEdit" style="color:#8a867e;text-decoration:underline;">Email preferences</a> &middot; <a href="${APP}" style="color:#8a867e;text-decoration:underline;">Visit CFF</a></td>
<td align="right" style="font-family:${DM};font-size:11px;font-weight:300;color:#3d3a35;">University of Florida &middot; ${YR}</td>
</tr></table></td></tr>
