...
<tr><td style="background-color:#0d1117;border-radius:16px 16px 0 0;padding:24px 32px;"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
...
<td align="right"><span style="background:rgba(232,93,32,0.15);border:1px solid rgba(232,93,32,0.3);border-radius:100px;padding:4px 12px;font-size:11px;font-weight:500;color:#E85D20;font-family:${DM};">FASTIQ&trade; Active</span></td>
</tr></table></td></tr>
