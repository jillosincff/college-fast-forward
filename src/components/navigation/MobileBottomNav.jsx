...
export default function MobileBottomNav({ user, currentPage }) {
  ...
  const getDashboardPage = () => {
    ...
    if (effectivePersona === 'parent') return 'ParentAllSet';
    ...
    if (user?.roles?.includes('parent')) return 'ParentAllSet';
  ...
  const isActive = (tabPage) => {
    const allDashboards = ['Dashboard', 'ParentAllSet', 'ParentDashboard', 'AlumniDashboard', 'RecentGradDashboard', 'AdminDashboard'];
