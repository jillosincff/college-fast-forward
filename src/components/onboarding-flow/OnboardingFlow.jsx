...
Return valid JSON matching the schema exactly.`,
  ...
  const shell = {
    ...
    background: screen >= 10 ? '#F8FAFC' : '#07080f',
  ...
  return (
    <div style={shell}>
      ...
      {/* Close */}
      <button onClick={onClose} style={{ position: 'absolute', top: 20, right: 20, width: 38, height: 38, minHeight: 'auto', borderRadius: '50%', background: screen >= 10 ? 'rgba(0,0,0,0.06)' : 'rgba(255,255,255,0.07)', border: `1px solid ${screen >= 10 ? 'rgba(0,0,0,0.1)' : 'rgba(255,255,255,0.12)'}`, color: screen >= 10 ? '#64748B' : 'rgba(255,255,255,0.5)', fontSize: 16, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>✕</button>
