    ...
    <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', marginBottom: 3 }}>
              <p style={{ fontFamily: sat, fontSize: 15, fontWeight: 800, color: TEXT, margin: 0 }}>
                Marketing Coordinator at Nexo Agency
              </p>
            </div>
      ...
      <div style={{ margin: '0 16px 0', background: BLUE_LIGHT, border: `1px solid ${BLUE_BRIGHT}`, borderRadius: 14, padding: '14px 16px', marginLeft: 16, marginRight: 16 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: CARD, border: `1px solid ${BLUE_BORDER}`, borderRadius: 10, padding: '10px 13px' }}>
          ...
          <div style={{ flex: 1 }}>
            <p style={{ fontFamily: dm, fontSize: 13, fontWeight: 700, color: TEXT, margin: 0 }}>Sarah K.</p>
            <p style={{ fontFamily: dm, fontSize: 11, color: TEXT2, margin: '2px 0 0' }}>
              Junior Marketing Manager &nbsp;·&nbsp;
              <span style={{ color: BLUE, fontWeight: 600 }}>{shortSchool} Alum</span>
            </p>
          </div>
          <span style={{ fontFamily: dm, fontSize: 10, fontWeight: 700, color: BLUE, background: BLUE_LIGHT, border: `1px solid ${BLUE_BORDER}`, borderRadius: 100, padding: '3px 9px', flexShrink: 0 }}>WARM MATCH</span>
        </div>
      </div>
