...
const FEATURES = [
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#E85D20" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export default function V3FastIQ247() {
  ...
  return (
    <section ref={ref} style={{ background: '#0d1219', padding: '120px 24px 130px' }}>
        ...
        <div className="v3-feat-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 16, ...fadeStyle(vis, 0.12) }}>
          {FEATURES.map((f, i) => (
            <div key={i} style={{
              ...
              onMouseEnter={(e) => { e.currentTarget.style.borderColor = 'rgba(232,93,32,0.25)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.07)'; }}
            >
              <div style={{
                width: 40, height: 40, borderRadius: 10, flexShrink: 0,
                background: 'rgba(232,93,32,0.08)', border: '1px solid rgba(232,93,32,0.15)',
