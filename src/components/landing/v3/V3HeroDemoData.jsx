...
const DEMO_SCENARIOS = [
  ...
  {
    promptTemplate: (school) => `I'm a CS major at ${school} and dream of working at Google — how do I get in?`,
    companies: [
      { name: 'Google', tag: 'Big Tech', asterisk: true },
      { name: 'Microsoft', tag: 'Big Tech' },
      { name: 'Apple', tag: 'Hardware/SW' },
      { name: 'Meta', tag: 'Social/AI' },
      { name: 'Amazon', tag: 'Cloud/E-comm' },
    ],
    hasAsterisk: true,
    alumniRoles: [
      { company: 'Google', role: 'Software Engineer', year: "'22" },
      { company: 'Microsoft', role: 'Program Manager', year: "'21" },
      { company: 'Meta', role: 'Product Analyst', year: "'23" },
    ],
    outreach: {
      company: 'Google',
      from: 'Marcus',
      bodyTemplate: (school, alumniName) =>
        `Hi ${alumniName.split(' ')[0]},\n\nI'm a CS major at ${school} and Google is my top target — I saw you're a software engineer there and would love to learn how you prepared and got your foot in the door.\n\nWould you have 15 minutes for a quick call?\n\nReally appreciate it,\nMarcus`,
    },
  },
  {
    promptTemplate: (school) => `I'm studying finance at ${school} and want to break into Goldman Sachs.`,
    companies: [
      { name: 'Goldman Sachs', tag: 'Investment Banking', asterisk: true },
      { name: 'JP Morgan', tag: 'Banking' },
      { name: 'Morgan Stanley', tag: 'Finance' },
      { name: 'Citadel', tag: 'Hedge Fund' },
      { name: 'BlackRock', tag: 'Asset Mgmt' },
    ],
    hasAsterisk: true,
    alumniRoles: [
      { company: 'Goldman Sachs', role: 'Investment Banking Analyst', year: "'22" },
      { company: 'JP Morgan', role: 'Equity Research Associate', year: "'21" },
      { company: 'Morgan Stanley', role: 'Wealth Mgmt Analyst', year: "'23" },
    ],
    outreach: {
      company: 'Goldman Sachs',
      from: 'Sophie',
      bodyTemplate: (school, alumniName) =>
        `Hi ${alumniName.split(' ')[0]},\n\nI'm a finance major at ${school} targeting investment banking — I saw you're at Goldman Sachs and would love to hear how you broke in and what the process was like.\n\nWould you have time for a quick 15-minute call?\n\nThanks so much,\nSophie`,
    },
  },
  {
