...
const STEPS = [
  {
    num: '01',
    title: 'Direction',
    desc: 'FastIQ helps your student figure out where to focus — target companies, industries, and roles that actually fit.',
    icon: (
  ...
  },
  {
    num: '02',
    title: 'Action',
    desc: 'It gives them a clear daily plan — specific steps, not vague advice — so they know exactly what to do next.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#E85D20" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    num: '03',
    title: 'Outreach',
    desc: 'It identifies real alumni at target companies, helps prioritize who to contact, and writes personalized messages.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#E85D20" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    num: '04',
    title: 'Momentum',
    desc: 'It keeps the process moving — follow-ups, tracking, weekly scouts — so your student builds real traction.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#E85D20" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    <section ref={ref} style={{ background: '#0a0f18', padding: '120px 24px 130px' }}>
      ...
      <div className="max-w-[820px] mx-auto">
        ...
        <p style={{ fontFamily: dmSans, fontSize: 17, color: 'rgba(255,255,255,0.6)', textAlign: 'center', marginBottom: 56, lineHeight: 1.6, maxWidth: 550, marginLeft: 'auto', marginRight: 'auto', ...fadeStyle(vis, 0.08) }}>
          A personalized AI career concierge that gives your student direction, action, outreach, and progress — every single day.
        </p>
