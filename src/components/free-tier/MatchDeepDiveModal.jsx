              ...
              <div ref={draftPanelRef} style={{ marginTop: 14, background: '#f5f3ff', border: '1.5px solid #c4b5fd', borderRadius: 16, padding: '14px 16px', animation: 'slideUp 0.3s ease' }}>
                ...
                {isGenerating ? (
                  ...
                  <>
                    ...
                    {isCopied && draftContact?.linkedin_url && (
                      <a
                        ...
                        style={{
                          ...
                          width: '100%', marginTop: 8, padding: '10px 0', border: 'none', borderRadius: 10, cursor: 'pointer', minHeight: 'auto',
                          fontFamily: dm, fontSize: 12, fontWeight: 800, letterSpacing: '0.04em',
                          background: '#0a66c2', color: '#fff', textDecoration: 'none',
                        }}
                      >
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="#fff"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                        Open {draftContact.name.split(' ')[0]}'s LinkedIn → Paste & Send
                      </a>
                    )}
                    {isCopied && !draftContact?.linkedin_url && (
                      <p style={{ fontFamily: dm, fontSize: 11, color: '#16a34a', textAlign: 'center', margin: '8px 0 0', fontWeight: 600 }}>
                        ✓ Paste this message in a LinkedIn DM or email to {draftContact?.name?.split(' ')[0]}
                      </p>
                    )}
                  </>
                )}
