  ...
  if (phase === 'analyzing') {
    return (
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '40px 24px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, color: '#1A1A1A', margin: '0 0 12px' }}>Analyzing {company}...</h2>
        <p style={{ fontFamily: dm, fontSize: 14, color: '#888' }}>Identifying the best contact for your outreach</p>
      </div>
    );
  }
