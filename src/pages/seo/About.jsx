      ...
      <Section narrow>
        ...
        <div style={{ background: CARD, border: `1px solid ${INDIGO_BORDER}`, borderRadius: 20, padding: 'clamp(24px,5vw,36px)', boxShadow: SHADOW_MD }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: 8 }}>
            <a href="https://www.linkedin.com/search/results/all/?keywords=Jill%20Osinoff%20College%20Fast%20Forward" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, fontFamily: SF, fontSize: 14, fontWeight: 700, color: '#fff', background: GRAD_INDIGO, borderRadius: 999, padding: '11px 22px', textDecoration: 'none', boxShadow: '0 6px 20px rgba(109,40,217,0.30)' }}>
