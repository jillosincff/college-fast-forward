    ...
    >
      ...
      <FeatureGrid
        ...
        items={[
          ...
          { icon: '🧠', title: 'Missing skills', desc: 'Spot skills the job description asks for that you left out.' },
        ]}
      />
      <Steps
        title="How scoring works"
        steps={[
          { title: 'Get a 0–100 ATS score', desc: 'A clear, instant score showing how resume-bot-friendly your resume is.' },
          { title: 'See your keyword match %', desc: 'Know exactly how closely your resume matches the job description.' },
          { title: 'Get specific recommendations', desc: 'Actionable fixes to raise your score before you apply.' },
        ]}
      />
