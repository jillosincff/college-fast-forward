...
export default function Onboarding() {
  ...
  const goToDashboard = () => {
    // Alumni helpers → ParentDashboard (they help students like parents do)
    // Alumni seekers → ParentDashboard (they need to see parent/alumni matches who can help them)
    // Both alumni intents go to ParentDashboard for now
    ...
    <div className="min-h-screen flex flex-col lg:flex-row overflow-x-hidden">
      ...
      <div className="lg:w-[55%] bg-white p-4 sm:p-6 lg:p-10 lg:pt-10 overflow-y-auto">
        <div className="max-w-xl mx-auto">
          ...
          {/* ===== ALUMNI STEP 5 (Seeker): What do you need help with ===== */}
          {step === 5 && isAlumniSeeker && (
            <>
              <div className="mb-6">
                <h2 className="text-xl lg:text-2xl font-bold text-slate-800 mb-1">
          ...
          {/* ===== PARENT STEP 4: Link Your Student ===== */}
          {step === 4 && !isAlumni && (
            <LinkStudentStep
              user={user}
              onComplete={(student) => {
          ...
          {/* STEP 5 (Parents) / STEP 8 (Alumni Helper) / STEP 9 (Alumni Seeker): Ready */}
            ...
            <>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-3">
                  <button
                    onClick={() => setStep(isAlumniSeeker ? 8 : (isAlumni ? 7 : 4))}
                    className="px-6 py-4 rounded-xl font-bold text-slate-600 border-2 border-slate-200 hover:bg-slate-50 transition-all"
                  >
                    ← Back
                  </button>
