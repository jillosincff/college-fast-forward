...
export default function GatorAuth() {
  ...
  // Login options screen - UNIFIED WELCOME PAGE
  if (showLoginOptions) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4" style={{
        ...
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-white/85 text-lg mb-8 leading-relaxed">
            Connect with UF students, parents, and alumni for career advice and opportunities
          </p>
          ...
          <div className="flex items-center my-6 max-w-sm mx-auto">
            ...
            <span className="px-4 text-white/60 text-sm">New here?</span>
            <div className="flex-1 h-px bg-white/30"></div>
          </div>

          {/* Info for new users */}
          <p className="text-white/80 text-sm max-w-sm mx-auto leading-relaxed">
            Just click above to get started! You'll choose your role (Student, Parent, or Alumni) after signing in.
          </p>

          {/* UF Student hint */}
          <div className="mt-8 pt-6 border-t border-white/20 max-w-sm mx-auto">
            <p className="text-white/70 text-sm">
              💡 <strong className="text-white">UF Students:</strong> Use your @ufl.edu email for instant access
            </p>
          </div>
